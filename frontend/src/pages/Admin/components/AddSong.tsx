...
const AddSong = () => {
    ...
    return (
        <div>
            <div className='w-full flex justify-end'><Button onClick={() => setShowPrompt(true)} className='m-3 md:mx-0 md:mt-0 bg-green-600 hover:bg-green-800 mb-2'><Plus />Add Song</Button></div>
