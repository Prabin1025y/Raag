...
const DeleteUser: React.FC<Args> = ({ setLogoutPromptVisible }) => {
    ...
    return (
        <div className='animate-in fade-in-0 duration-500 z-50 bg-black/80 h-screen w-screen fixed top-0 left-0 grid place-items-center'>
