...
const UserPanelMd = ({ setShowUserPanel }: { setShowUserPanel: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    return (
        <div ref={divRef} className="animate-in slide-in-from-right-96 fade-in-0 duration-300 h-[calc(100vh-180px)] md:h-[calc(100vh-120px)] bg-[#3B1E54] mt-3 mr-3 rounded-md p-2 py-12 xl:p-6 font-[Roboto] overflow-x-hidden fixed top-0 right-0 z-40 w-[60vw] shadow-2xl md:hidden">
            {authUser ? <>
